...
pie(
  ...
  labels = c("Femenino 40.40%", "Masculino 30.81%", "Otro 28.79%"),
...
En el Gráfico 3 se puede observar que la mayor cantidad de viajes se
efectúan los dias viernes. Se puede suponer que ese día se efectúan dicha
...
El rango de la variable en el grupo de 46 a 72 es el más extenso y tiene el mayor máximo.
...
Siendo el grupo hetario [16,21] el que más respeta el tiempo límite. Y el grupo de [46,72] es el que más lo excede.
...
Los usuarios del servicio de bicicletas suelen ser gente de entre 20 y 40 años, de ambos géneros aunque hay una pequeña mayoría de mujeres.
