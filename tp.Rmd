...
y Bivariados para tener una mayor apreciación de la utilidad de las mismas.
...
Es una variable cuantitativa continua cuyos valores están entre 15 y 72.
...
### Variable estación de Destino (Tabla de Frecuencias mas Grafico de Barras)
...
Mediana: 4.36<br>
Media: 4.96<br>
Maximo: 18.30 (outlier)

### Variable duración

Es una variable cuantitativa continua.
Sus valores están entre 0.4 hs y  10 hs
Cualquier apreciación mayor a 10 hs es considerada un error de sistema o humano y por lo tanto no es tenida en cuenta en el análisis.
...
El minimo tiempo transcurrido fue 4 min y el maximo fue 473.2 min

El 25% de los usuarios utilizo el servicio menos de 13.59 min

El 50% de los usuarios utilizo el servicio menos de 21.73 min

El 75% de los usuarios utilizo el servicio menos de 31.21 min
...
A partir del grafico de bastones se puede ver que:
