...
``` {r genero, fig.align='center', out.width = "70%"}
...
En el Grafico 2.1 y 2.2, se muestran los polígonos de Frecuencias Relativas y
Absolutas de los usuarios respecto de la edad de los mismos.

En el Grafico 2.1, se puede ver claramente el aumento del uso de las ecobici,
...
- Mediana: 30
- Media: 31.97
- Desvío estandar: 9.89 (desviación "típica" de la media de 9.89 años)
- Moda: 225
- Maximo: 72
...
En el Grafico 3 se puede observar que la mayor cantidad de viajes se
...
En el Grafico 4 se puede ver a partir de la tabla que alrededor del 27% de los viajes se originaron en sólo 15 de las 169 estaciones.
...
En el Grafico 5 se puede ver que a partir de la tabla, alrededor de 26% de los viajes tuvieron como destino
...
En el Grafico 6 se puede ver que:
...
A partir del Grafico 7 se puede ver que:
...
boxplot((bivar$distancia)~(bivar$edad), horizontal = TRUE, outline = FALSE,
        main = "Grafico 9: DURACION DEL RECORRIDO SEGUN \n LA EDAD DEL USUARIO, CABA 2020",
        sub="Fuente: Datos sustraidos de las estaciones de las bicicletas publicas de CABA",
        cex.sub = 0.9,
        las = 1,
        ylab = "",
        names = c("De 16 a 21 años", "De 22 a 30 años","De 30 a 45 años", "De 45 a 72 años"),
        xlab = "Duración en minutos", boxfill = "lightblue")
```
